...
<head>
	<!-- 
	Buil with Bootstrap
	Irvin S. Cardenas - kPatch
	Twitter: ElectroFunks
	-->
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="">
	<meta name="author" content="Irvin Steve Cardenas">
	<title>Welcome to Fitgram - Your daily dose of fitness</title>
	<!-- Bootstrap core CSS -->
	...
	<div id="wrap">
		...
		<div class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.html">Fitgr.am</a>
				</div>
		...
		<div class="container" id="home">
			<div class="row">
				<div class="col-md-7">
					<h3 class="slogan">
						Fitgr.am lets you promote and share your fit and healthy lifestyle.
					</h3>
				...
				<div class="col-md-5">
					<form action="#" method="post" class="form" role="form">
						...
						<h4>It's free, start getting fit today!</h4>
						<div class="row">
						...
						<label for="">
							...
							<div class="row">
								<div class="col-xs-4 col-md-4">
									<select name="birthday_month" id="month" class="form-control input-lg">
								...
								<div class="col-xs-4 col-md-4">
									<select name="birthday_day" id="day" class="form-control input-lg">
								...
								<div class="col-xs-4 col-md-4">
									<select name="birthday_day" id="year" class="form-control input-lg">
							...
							<br />
							<span class="help-block">By clicking Create My Account, you agree to our <a href="#">Terms</a> and that you have read our <a href="#">Data Use Policy</a>, including our Cookie Use.</span>
			...
			<div id="footer">
				<div class="container">
					<p class="text-muted credit">An <a href="http://itsirv.in">Irvin</a> production</p>
				</div>
			</div>
